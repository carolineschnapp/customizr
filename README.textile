...
Customizr uses the old tried and true method of saving product attributes in a cookie until checkout. At checkout, the cookie is read and its data is submitted as cart attributes to the back-end using Shopify's Ajax API.
